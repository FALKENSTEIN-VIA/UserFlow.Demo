...
public interface IUserService
{
    ...
    Task<IEnumerable<UserDTO>> GetAllUsersAsync(bool includeCompany = false);
    ...
    Task<UserDTO?> GetUserByIdAsync(long id, bool includeCompany = false);
    ...
    Task<BulkOperationResultDTO<UserDTO>> BulkCreateUsersAsync(List<CreateUserByAdminDTO> dtos);
